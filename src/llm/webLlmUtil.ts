...
export async function webLlmGenerate(connection: LLMConnection, llmMessages: LLMMessages, prompt: string, onStatusUpdate: StatusUpdateCallback, temperature?: number): Promise<string> {
